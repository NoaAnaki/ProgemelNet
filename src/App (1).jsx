...
function ChartModal({ fund, mainSeries, avgSeries, ranges, range, setRange, minV, maxV, valRange, onClose }) {
  ...
  return (
    <div onClick={onClose} style={{ position:'fixed',inset:0,background:'rgba(0,0,0,0.65)',zIndex:9000,display:'flex',alignItems:'center',justifyContent:'center' }}>
    ...
    <div style={{ minHeight:'100vh',background:C.bg,fontFamily:"'Assistant','Heebo',Arial,sans-serif",direction:'rtl' }}>
      ...
      <div style={{ display:'flex',minHeight:'calc(100vh - 56px)' }}>
        <div style={{ flex:1,minWidth:0,display:'flex',flexDirection:'column' }}>
          ...
          <TrackBrowser product={product} onSelectFund={f=>{setSelFund(f);setSelCatId(null);}} selFund={selFund}/>
